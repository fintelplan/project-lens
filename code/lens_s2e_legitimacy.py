...
- RULE_OF_LAW: Is there an independent judiciary and legal system in their jurisdiction? (0=no, 1=yes)
- PRESS_FREEDOM: Is independent media permitted and operating in their jurisdiction? (0=no, 1=yes)
- CIVIL_SOCIETY: Can independent NGOs and civil society organizations operate freely? (0=no, 1=yes)
- ACCOUNTABILITY: Are there functioning checks and balances (legislature, courts, free press)? (0=no, 1=yes)
- INTERNATIONAL_NORMS: Does this actor generally comply with UN charter and international law? (0=no/violator, 1=yes/compliant)

Scoring:
- Each dimension: 0.0 (clearly fails), 0.5 (partial/contested), 1.0 (clearly meets standard)
...
- Use Freedom House, RSF Press Freedom Index, and V-Dem as implicit reference frameworks
