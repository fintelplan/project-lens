...
MAX_S1_REPORTS = 30
MAX_S2_REPORTS = 20
# CC-99 (LENS-045): the window sampler moved, unchanged, to lens_window_sample.py
# so S3-A can share it without importing this module (basicConfig + wire() at import).
from lens_window_sample import (PAGE, MAX_PAGES, even_sample, _parse_ts,
                                even_sample_by_time, newest_third, window_span,
                                sample_window)
